 ...
 * @param {string} inputMdPath - Path to the input Markdown file.
 ...
 */
async function mdToHtml(inputMdPath, stylesheetPath, options = {}, extensions = []) {
    ...
    // Always enable markdown-it-callouts
    md.use(markdownItCallouts);

    // Enable markdown-it-anchor unless headerIDs is false
...
<head>
<meta charset="UTF-8">
<title>${path.basename(inputMdPath, path.extname(inputMdPath))}</title>
${stylesheetTag}
</head>
<body>
${htmlContent}
