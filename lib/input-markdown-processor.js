...
export function processInputMarkdown(inputFilePath) {
...
function removeFrontmatter(mdContent) {
    return mdContent.replace(/^---\s*([\s\S]*?)\s*---/m, '');
}
